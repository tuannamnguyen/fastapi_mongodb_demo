...
@student_router.get("/students/{student_id}", status_code=status.HTTP_200_OK)
...
@student_router.put("/students/{student_id}", status_code=status.HTTP_201_CREATED)
...
@student_router.delete("/students/{student_id}", status_code=status.HTTP_200_OK)
